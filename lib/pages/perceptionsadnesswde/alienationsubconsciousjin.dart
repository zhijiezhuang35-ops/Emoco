...
class _AlienationsuBconsciousJin extends State<AlienationsuBconsciousJin> {
                ...
                children: [
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                '  Balance: ${getClardisgustUinfo(WitbanTer().rabilitycelogid)[3]}',
                  ...
                  SizedBox(
                    ...
                    child: Wrap(
                      ...
                      spacing: 11.5,
                      children: [
                        for (var emoco in WitbanTer().freedompendcoin)
  ...
  Widget _attachmentjin(emoco) {
    return GestureDetector(
      behavior: HitTestBehavior.translucent,
      onTap: () {
        _purchaseManager.goEigstraiNht(emoco["shocdisbeliefk"][1]);
      },
      child: SizedBox(
        width: 104,
        height: 116,
